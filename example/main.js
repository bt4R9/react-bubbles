...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Bubbles = __webpack_require__(159);
	    ...
	    _createClass(Parent, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Bubbles2.default, {
	                    onChange: function onChange(list) {
	                        return console.log('onChange', list.toJSON());
	                    },
	                    'class': 'set',
	                    bubbleComponent: Bubble,
	                    bubbles: ['email', 'email@domain.ru', '<script>alert(1)</script>']
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selection = __webpack_require__(161);

	var _utils = __webpack_require__(164);

	var _bubbleRecord = __webpack_require__(165);

	var _bubbleRecord2 = _interopRequireDefault(_bubbleRecord);

	var _keyCodes = __webpack_require__(166);
	...
	var Bubbles = function (_Component) {
	    ...
	    function Bubbles(props) {
	        ...
	        _this.attachEvents = _this.attachEvents.bind(_this);
	        _this.deattachEvents = _this.deattachEvents.bind(_this);
	        _this.onPaste = _this.onPaste.bind(_this);

	        _this.state = { bubbles: (0, _immutable.List)() };
	        return _this;
	    }
	    ...
	    _createClass(Bubbles, [{
	        key: 'appendBubble',
	        value: function appendBubble(content, index) {
	            content = (0, _utils.prepareContent)(content);

	            if (!(0, _utils.isUniqueBubble)(this.state.bubbles, content)) {
	                (0, _selection.moveCaretToTheEnd)(this.editor);
	            } else if (index !== undefined) {
	                this.setState({ bubbles: this.state.bubbles.set(index, new _bubbleRecord2.default({ content: content })) });
	            } else {
	                this.setState({ bubbles: this.state.bubbles.push(new _bubbleRecord2.default({ content: content })) });
	            }
	        ...
	        key: 'removeBubble',
	        value: function removeBubble(index) {
	            if (index !== undefined) {
	        ...
	        key: 'onBackSpace',
	        value: function onBackSpace(e) {
	            var selection = window.getSelection();
	            var focusNode = selection.focusNode;
	            var prevNode = focusNode.previousSibling;
	            var node = focusNode.parentNode;
	            var code = focusNode.textContent.charCodeAt(0);

	            if ((0, _selection.isBubbleEditing)(node)) {
	                if (selection.toString() === focusNode.textContent) {
	                    var nodeIndex = (0, _utils.getNodeIndexOf)(this.editor, node);
	            ...
	            if (code === _keyCodes2.default.ZEROWIDTHSPACE && focusNode.textContent.length === 1) {
	        ...
	        value: function onClick(e) {
	            ...
	            if (node !== this.editor && !(0, _selection.isBubbleEditing)(node)) {
	                (0, _selection.startBubbleEditing)(node);
	            }
	        ...
	        value: function onPaste(e) {
	            ...
	            if (e.clipboardData && e.clipboardData.types && e.clipboardData.getData) {
	                ...
	                var content = (0, _utils.prepareContent)(data);

	                if ((0, _utils.isUniqueBubble)(this.state.bubbles, content)) {
	                    var record = new _bubbleRecord2.default({ content: content });

	                    this.setState({
	                        bubbles: this.state.bubbles.push(record)
	                    }, function () {
	                        return _this2.props.onChange(_this2.state.bubbles.toList());
	                    });
	                }
	            }
	        }
	        ...
	        key: 'finishEditingBubbles',
	        value: function finishEditingBubbles() {
	            var _this3 = this;

	            var editingNodes = [];

	            this.editor.childNodes.forEach(function (node) {
	                if (node.nodeType === Node.ELEMENT_NODE && (0, _selection.isBubbleEditing)(node)) {
	                    editingNodes.push(node);
	                }
	            });

	            editingNodes.forEach(function (node) {
	                var content = (0, _utils.prepareContent)(node.textContent);
	                var nodeIndex = (0, _utils.getNodeIndexOf)(_this3.editor, node);
	                var listIndex = _this3.state.bubbles.findIndex(function (item) {
	                    return item.get('content') === content;
	                });

	                if (listIndex !== -1 && nodeIndex !== listIndex) {
	                    _this3.removeBubble(nodeIndex);
	                } else {
	                    _this3.appendBubble(content, nodeIndex);
	                }

	                (0, _selection.endBubbleEditing)(node);
	            });
	        }
	        ...
	        key: 'convertTextNodesToBubbles',
	        value: function convertTextNodesToBubbles() {
	            var _this4 = this;
	        ...
	        value: function componentDidMount() {
	            ...
	            if (bubbles && bubbles.length > 0) {
	                var bubbleRecords = (0, _immutable.fromJS)(bubbles).map(function (bubble) {
	                    return new _bubbleRecord2.default({ content: (0, _utils.prepareContent)(bubble) });
	                });
	                this.setState({ bubbles: this.state.bubbles.merge(bubbleRecords) }, function () {
	                    return (0, _selection.moveCaretToTheEnd)(_this5.editor);
	                });
	            }
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var bubbleComponent = this.props.bubbleComponent;
	            var bubbles = this.state.bubbles.map(function (bubble) {
	                var content = bubble.get('content');
	            ...
	            return _react2.default.createElement(
	                'div',
	                {
	                    ...
	                    onBlur: function onBlur() {
	                        return _this6.onBlur();
	                    },
	                    ref: function ref(node) {
	                        return _this6.editor = node;
	                    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.moveCaretToTheEnd = moveCaretToTheEnd;
	exports.startBubbleEditing = startBubbleEditing;
	exports.endBubbleEditing = endBubbleEditing;
	exports.isBubbleEditing = isBubbleEditing;
	...
	function moveCaretToTheEnd(node) {
	...
	function startBubbleEditing(node) {
	...
	function endBubbleEditing(node) {
	    node.setAttribute('contentEditable', 'false');
	    node.classList.remove(EDITING_CLASS);
	}

	function isBubbleEditing(node) {
...
/***/ function(module, exports) {
	...
	exports.getNodeIndexOf = getNodeIndexOf;
	exports.isUniqueBubble = isUniqueBubble;
	exports.prepareContent = prepareContent;
	function getNodeIndexOf(parent, child) {
	    return Array.prototype.indexOf.call(parent.childNodes, child);
	}

	function isUniqueBubble(list, content) {
